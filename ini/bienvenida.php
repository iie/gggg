...
<script src="js/jquery-2.2.4.min.js"></script>
  <script src="js/jquerrut.js"></script>
 	...
 	<div class="main">
		...
		<br>
		<a href="http://localhost/limesurvey/index.php/952371?lang=es"> Registrese</a>
 	</div>
    ...
    if(de === false){
        alert("El rut ingresado es invalido");
			...
			success:function(data){
				...
				if ((JSON.parse(data).token)== null ) {
					localStorage.setItem("puc_rut", $("#lorut").val());
					location.href="/limesurvey/index.php/952371?lang=es";
				}else{

					location.href= "/limesurvey/index.php/952371/lang/es/token/"+(JSON.parse(data).token);
